 ...
 */
function handleFetchMedicalNotesSuccess(data) {
    if (data.success) {
        ...
        var tableBody = document.querySelector(noteTBodyId);
 ...
 * @returns
 */
function noteToHTML(medicalNotes) {
    var html = '';
