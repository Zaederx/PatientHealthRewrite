 ...
 */
function handleFetchAppointmentsSuccess(data) {
    ...
    if (data.success) {
        ...
        var tableBody = document.querySelector(appointmentTableBodyId);
 ...
 * @returns
 */
function appointmentsToHtml(appointments) {
    var html = '';
 ...
 * Fills table with fetched data
 */
function handleFetchPatientAppointmentRequestsSuccess(data) {
    ...
    if (data.success) {
        ...
        //make table clickable
        var tableBody = document.querySelector(appointmentRequestTableBodyId);
 ...
 * @returns
 */
function patientAppointmentsRequestsToHtml(appointments) {
    var html = '';
    appointments.forEach(a => {
        html += '<tr data-id="' + a.id + '" data-selected="false">' +
            '<td>' + a.appointmentType + '</td>' +
 ...
 */
function displayAppointmentRequest(id) {
    //find request
 ...
 */
function fillFormWithRequestDetails(r) {
    //appointment type
