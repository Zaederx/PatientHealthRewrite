...
function setPageNumVarsCalendar(currentPageNum) {
...
export function getCurrentWeekAppointments(docId) {
    if (docId != '' && docId != null) {
        //set current
        $.ajax({
...
export function openAppointmentPopup_AddMode(date) {
    //fill popup fields
...
export function openAppointmentPopup_ViewMode(appointment) {
...
export function submitAppointment(url, appointmentId) {
...
export function handleCreateAppointmentSuccess(data) {
    if (data.success) {
...
export function appointmentToHtml(a) {
    //work out position
...
export function handleViewAppointmentSuccess(data) {
    if (data.success) {
 ...
 * @returns
 */
function appointmentPosition(divHeight, hour, minute) {
    //hour and 
...
function appointmentDurationLength(divHeight, durationInMinutes) {
    // constants
    const surgeryHours = 12;
    const sixtyMins = 60;
    //height of single unit - hour and mintue
...
var weekISO = '';
export function handleCalendarSuccess(data) {
    if (data.success) {
        ...
        data.week.monday.appointments.forEach(a => {
            var appointmentHTML = appointmentToHtml(a);
        ...
        var mondayDiv = document.querySelector('#monday-appointments');
        var tuesdayDiv = document.querySelector('#tuesday-appointments');
        var wednesdayDiv = document.querySelector('#wednesday-appointments');
        var thursdayDiv = document.querySelector('#thursday-appointments');
        var fridayDiv = document.querySelector('#friday-appointments');
        var saturdayDiv = document.querySelector('#saturday-appointments');
        var sundayDiv = document.querySelector('#sunday-appointments');
...
export function getAppointments(docId, weekNumber, success = handleCalendarSuccess) {
    if (docId && weekNumber) {
        $.ajax({
...
export function viewAppointment(id) {
...
export function setCurrentDoctorId(id) {
    currentDoctorId = id;
}
...
$('#btn-calendar-week-go').on('click', () => {
    //TODO //IMPORTANT
    var weekNum = Number($('#weekNum').html());
